...
//		listView.setAdapter(contactsAdapter);
        ...
        btnPhoto.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                piclureFile = new File(Environment.getExternalStorageDirectory() + File.separator + "image.jpg");
                cameraIntent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(piclureFile));
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case PHOTO_TAKEN_RESULT:
                        Uri selectedImage = Uri.fromFile(piclureFile);
                        Intent intent = new Intent(this, PaintActivity.class);
                        intent.putExtra(PaintActivity.EXTRA_PICTURE_URI, selectedImage);
                        intent.putExtra(GroupActivity.EXTRA_GROUP_ID, group.id);
                        startActivityForResult(intent, PHOTO_SENT_RESULT);
